...
! function(D, u) {
    ...
    function emojiSafeSplit(D, u, F, C, E) {
        if (D += "", F && (D = D.trim ? D.trim() : D.replace(s, "")), u && "" !== u) return D.replace(/>/g, "&gt;").replace(/</g, "&lt;").split(u);
        for (var e, t, i = [], n = D.length, r = 0; r < n; r++)(55296 <= (t = D.charAt(r)).charCodeAt(0) && t.charCodeAt(0) <= 56319 || 65024 <= D.charCodeAt(r + 1) && D.charCodeAt(r + 1) <= 65039) && (e = ((D.substr(r, 12).split(a) || [])[1] || "").length || 2, t = D.substr(r, e), r += e - (i.emoji = 1)), i.push(E ? t : ">" === t ? "&gt;" : "<" === t ? "&lt;" : !C || " " !== t || " " !== D.charAt(r - 1) && " " !== D.charAt(r + 1) ? t : "&nbsp;");
        return i
    }
    var o = (CharSet.prototype.grow = function grow(D) {
    ...
    var u, B, l = /\s+/g,
        ...
        e = {
            ...
            init: function init(D, u, F) {
                if (B || p(), this.prop = "innerHTML" in D ? "innerHTML" : "textContent" in D ? "textContent" : 0, this.prop) {
                    this.target = D, "object" != typeof u && (u = {
                        text: u
                    });
                    var C, E, e, t, i = u.text || u.value || "",
                        n = !1 !== u.trim,
                        r = this;
            ...
            render: function render(D, u) {
                var F, C, E, e, t, i, n, r, s, a, o, B = u.target,
                    l = u.prop,
                    A = u.text,
                    h = u.delimiter,
                    p = u.tween,
